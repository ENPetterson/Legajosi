<script type="text/javascript">
    $(document).ready(function () {
        ...
        var source = {
            ...
            id: 'id',
            url: '/grilla/gatito/id-nombre-apellido-domicilio/nombre',
        ...
        {		
            ...
            columns: [
                    ...
                    { text: 'Domicilio', datafield: 'domicilio', width: 200 },
            ]
        });
        ...
        $("#nuevoButton").click(function(){
            $.redirect('/gatito/editar', {'id': 0});
        });
        
        $("#editarButton").click(function(){
            $.redirect('/gatito/editar', {'id': id});
        });
        
        $("#borrarButton").click(function(){
            new Messi('Desea borrar el gatito ' + nombre + ' ?' , {title: 'Confirmar', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        datos = {
                            id: id
                        };
                        $.post('/gatito/delGatito', datos, function(data){
