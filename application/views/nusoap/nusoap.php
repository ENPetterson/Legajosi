...
$namespace = "https://calculadora.allaria.test/nusoap";
...
function HelloComplexWorld()
{
    ...
    $result = array();
    $result[] = array( 'contact' => 'TManoj', 'email' => 'manoj@gmail.com');
    $result[] = array( 'contact' => 'Bojjaiah', 'email' => 'bojjaiah.t@gmail.com');
    return $result;	
}
