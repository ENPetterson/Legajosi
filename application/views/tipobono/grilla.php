<script type="text/javascript">
    $(document).ready(function () {
        ...
        var source = {
            ...
            id: 'id',
            url: '/grilla/tipobono/id-nombre/nombre',
            async: false
        };
        ...
        {		
            ...
            columns: [
                    ...
                    { text: 'TipoBono', datafield: 'nombre', width: 250 }
            ]
        });
        ...
        $("#borrarButton").click(function(){
            new Messi('Desea borrar el tipo de bono ' + nombre + ' ?' , {title: 'Confirmar', modal: true,
