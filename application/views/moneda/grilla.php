<script type="text/javascript">
    $(document).ready(function () {
        ...
        var source = {
            ...
            id: 'id',
            url: '/grilla/moneda/id-nombre/nombre',
            async: false
        };
        ...
        {		
            ...
            columns: [
                    ...
                    { text: 'Moneda', datafield: 'nombre', width: 250 }
            ]
        });
        ...
        $("#nuevoButton").click(function(){
            $.redirect('/moneda/editar', {'id': 0});
        });
        
        $("#editarButton").click(function(){
            $.redirect('/moneda/editar', {'id': id});
        });
        
        $("#borrarButton").click(function(){
            new Messi('Desea borrar el moneda ' + nombre + ' ?' , {title: 'Confirmar', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        datos = {
                            id: id
                        };
                        $.post('/moneda/delMoneda', datos, function(data){
