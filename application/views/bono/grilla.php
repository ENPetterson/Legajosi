<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#ventanaGrilla").jqxWindow({showCollapseButton: false, maxWidth: 1500, height: 480, width: 1265, theme: theme,
        ...
        var source = {
            ...
            datafields: [
                ...
                { name: 'nombre'},
                { name: 'emisor_nombre'},
                { name: 'tipobono_nombre'},
                { name: 'codigocaja'},
                { name: 'codigoisin'}
            ],
            id: 'id',
            url: '/grilla/v_bono/id-nombre-emisor_nombre-tipobono_nombre-codigocaja-codigoisin/nombre',
            async: false
        };
        ...
        {		
            ...
            columns: [
                    ...
                    { text: 'Emisor', datafield: 'emisor_nombre', width: 250 },
                    { text: 'Tipo de Bono', datafield: 'tipobono_nombre', width: 250 },
