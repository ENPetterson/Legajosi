<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#ventanaGrilla").jqxWindow({showCollapseButton: false, height: 480, width: 790, maxWidth:790, theme: theme,
        ...
        var source = {
            ...
            id: "id",
            url: '/grilla/v_menu/id-padre_id-padre-nombre-accion/nombre',
            async: false
        };
        ...
        {		
                ...
                columns: [
                        ...
                        { text: 'padre_id', datafield: 'padre_id', width: 0, 'hidden': true },
                        { text: 'Padre', datafield: 'padre', width: 250 },
                        { text: 'Estado', datafield: 'nombre', width: 250 },
                        { text: 'Accion', datafield: 'accion', width: 250 }
                ]
        });
        ...
        $("#nuevoButton").click(function(){
            $.redirect('/menu/editar', {'id': 0});
        });
        
        $("#editarButton").click(function(){
            $.redirect('/menu/editar', {'id': id});
        });
        
        $("#borrarButton").click(function(){
            new Messi('Desea borrar el menu ' + nombre + ' ?' , {title: 'Confirmar', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        datos = {
                            id: id
                        };
                        $.post('/menu/delMenu', datos, function(data){
